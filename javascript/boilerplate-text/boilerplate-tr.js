...
s.translationDisclaimer = `Bu belge bir çeviridir. Herhangi bir tutarsızlık veya hata durumunda, <a href="${ s.englishOriginal }">en son tarihli İngilizce orijinal belge</a> esas alınmalıdır. <a href="#copyright">Orijinal belgenin telif hakkı</a> aşağıdaki belirtildiği gibi W3C'ye aittir.`  // text appears only on translated pages
