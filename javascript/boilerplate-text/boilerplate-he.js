...
s.translationDisclaimer = `המסמך הינו תרגום. במקרה של טעויות או אי התאמות כלשהן עם המסמך המקורי, <a href="${ s.englishOriginal }">המקור האחרון באנגלית</a> יחשב כאמין יותר.`  // text appears only on translated pages
