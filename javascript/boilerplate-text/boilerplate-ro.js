...
s.historyOfDocumentChanges = 'Pentru a vedea toate schimbarile documentului, cauta <span class="searchkey"><a href="http://www.w3.org/blog/International/tag/'+f.searchString+'/">'+f.searchString+'</a></span> pe blogul i18n.'
s.untranslatedChanges = '<strong>Nota:</strong> Au fost efectuate modificari asupra  <a href="'+f.filename+'.en">versiunii originale in Engleza</a> dupa ce a fost tradus. <span class="searchkey"><a href="http://www.w3.org/blog/International/tag/'+f.searchString+'/">Vezi istoricul schimbarii.</a></span>'
