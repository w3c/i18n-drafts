...
s.translationDisclaimer = `Este documento é uma tradução. Se ocorrerem discrepâncias ou erros, o <a href="${ s.englishOriginal }">original em inglês mais recente</a> terá precedência. <a href="#copyright">Os direitos autorais originais</a> pertencem à W3C, como indicado abaixo.`  // text appears only on translated pages
...
s.untranslatedChanges = `<strong>Nota:</strong> Depois que este documento foi traduzido,  alterações foram feitas no <a href="${ s.englishOriginal }">documento original em inglês.</a> The changes were incorporated into this page, so you may see some passages in English until the translation is updated.`
