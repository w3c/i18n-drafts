...
s.untranslatedChanges = `<strong>Примітка:</strong> Зміни були внесені до <a href="${ s.englishOriginal }">написаного англійською мовою оригіналу</a>, так як цей документ був переведений. The changes were incorporated into this page, so you may see some passages in English until the translation is updated.`
