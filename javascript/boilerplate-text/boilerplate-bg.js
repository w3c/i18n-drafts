...
s.status_obsolete="Тази страница не е актуална. Тя вече не се обновява и може да е неточна. За по-актуална информация, вижте the <a href='https://www.w3.org/International/'>Internationalization Activity начална страница</a>."
