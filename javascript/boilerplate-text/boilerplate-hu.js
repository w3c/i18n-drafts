...
s.historyOfDocumentChanges = 'Amennyiben a dokumentum volt változataira kíváncsi, ezek az információk elérhetők a <a href="https://www.w3.org/blog/International/tag/'+f.searchString+'/">hírlevelünkön</a>, a 2016 Január óta bekövetkezett változásokról pedig a <a href="https://github.com/w3c/i18n-drafts/commits/gh-pages/'+f.directory+f.filename+'.en.html">GitHub „<span lang="en">commit</span>” lista</a> a megfelelő forrás.'
...
s.status_obsolete="Ez a cikk mára már elavult. Új verziói már nem készülnek, és valószínűleg pontatlanságokat tartalmaz. Frissebb információkért forduljon a <a href='https://www.w3.org/International/'>W3C Nemzetköziesítés Fejlesztési Tevékenység honlapjához.</a>."
