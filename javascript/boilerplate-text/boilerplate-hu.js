...
s.historyOfDocumentChanges = 'A dokumentum módosításainak a történetéhez keresse ezt az i18n blogban: <span class="searchkey"><a href="http://www.w3.org/blog/International/tag/'+f.searchString+'/">'+f.searchString+'</a></span>'
s.untranslatedChanges = '<strong>Megjegyzés:</strong> Változások történtek <a href="'+f.filename+'.en.php">az eredeti angol változatban</a> amióta a dokumentum le lett fordítva. <span class="searchkey"><a href="http://www.w3.org/blog/International/tag/'+f.searchString+'/">Változások megtekintése.</a></span>'
