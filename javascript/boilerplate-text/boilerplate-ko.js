...
s.translationDisclaimer = `이 문서는 번역본입니다. 일치하지 않는 사항이나 오류가 있는 경우에는 <a href="${ s.englishOriginal }">최신 영문 원본</a> 을 참고하십시오. <a href="#copyright">원본 저작권</a> 은 아래와 같이 W3C에게 있습니다.`  // text appears only on translated pages
