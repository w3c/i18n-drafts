...
s.home = "홈"
s.aboutI18nActivity = "국제화 활동 정보."
s.about = "정보"
s.groupsThatMakeUp = "국제화 활동을 구성하는 단체."
s.groups = "단체"
s.topicIndexForInformation = "이 사이트의 정보에 대한 항목 색인."
s.topics = "항목"
s.taskBasedIndex = "i18n 기술의 작업 기반 색인."
s.techniques = "기술"
s.informationResources = "국제화 사이트에 대한 정보 리소스."
s.resources = "리소스"
s.newsFiltersAndFeeds = "W3C 국제화를 위한 뉴스 필터 및 RSS 피드 정보."
s.news = "뉴스"
